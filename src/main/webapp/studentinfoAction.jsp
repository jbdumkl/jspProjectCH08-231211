...
<body>
	<jsp:useBean id="student" class="com.mkl.test.Student"/>
	...
	학생이름 : <jsp:setProperty property="name" name="student"/><br>
	학생나이 : <jsp:setProperty property="age" name="student"/><br>
	학생학년 : <jsp:setProperty property="grade" name="student"/><br>
